...
<!--
/*
Template       :  Digital Edge Web Services
Author         :  Santos Rivera
GitHub         :  https://github.com/srivera145
Facebook       :  https://facebook.com/digitaledgewebservices
Website        :  https://digitaledgewebservices.herokuapp.com
LinkedIn        :  https://www.linkedin.com/in/digitaledgewebservices
*/
-->
...
Template       :  Digital Edge Web Services
Author         :  Santos Rivera
GitHub         :  https://github.com/digitaledgewebservices
Facebook       :  https://facebook.com/digitaledgewebservices
Website        :  https://digitaledgewebservices.herokuapp.com
LinkedIn        :  https://www.linkedin.com/in/digitaledgewebservices
*/
    ...
    <div class="about-me container">
      ...
      <div class="row">
        <div class="col-lg-4" data-aos="fade-right">
          <img src="assets/img/me.png" class="img-fluid" alt="" style=" width: 80%;">
        </div>
          ...
          ?>
            <div class="col-lg-3 col-md-4">
              <div class="icon-box">
                ...
                <img src="<?=$skills_row['image']?>" class="img-fluid" alt="">
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4>Santos Rivera</h4>
            <p><em>Highly skilled and motivated professional with a proven track record in Web Development. Demonstrated expertise in Web Development. Strong problem-solving abilities combined with excellent communication and interpersonal skills. Dedicated and proactive individual with a passion for Web Development. Adaptable and quick learner, adept at managing multiple tasks and meeting deadlines. Committed to delivering exceptional results and exceeding expectations. Seeking a challenging position where I can utilize my skills and experience to contribute to the success of an organization.</em></p>
            <p>
            <ul>
              <li>Tampa, FL</li>
              <li>850-843-2170</li>
              <li>srivera145@gmail.com</li>
            </ul>
            </p>
          </div>
          ...
          <div class="resume-item">
            ...
            <h5>2015 - 2016</h5>
            <p><em>University of Central Florida - College of Engineering and Computer Science</em></p>
            
          </div>
          <div class="resume-item">
            <h4>Bachelor of Fine Arts &amp; Graphic Design</h4>
            <h5>2010 - 2014</h5>
            <p><em>University of Florida: Offers a BFA in Art and Art History</em></p>
        ...
        <?php
          if($services_result -> num_rows > 0){
            while($services_data = $services_result->fetch_assoc()){
              ?>
                <div class="p-2 col-lg-4 col-md-6 d-flex align-items-stretch">
                  <div class="icon-box">
...
-->
        ...
        <div class="text-center p-2"><button class="send_message btn btn-primary" type="submit" name="send_message">Send Message</button></div>
      </form>
